...
- **Implementacion de Aspectos Basicos**: Consulta [`src/main/kotlin/documentation/BasicsReadme.md`](src/main/kotlin/documentation/BasicsReadme.md)
- **Implementación de SQLite y Arquitectura Limpia**: Consulta [`src/main/kotlin/documentation/SQLiteReadme.md`](src/main/kotlin/documentation/SQLiteReadme.md)
- **Estrategia de Testing**: Consulta [`src/main/kotlin/documentation/TestingReadme.md`](src/main/kotlin/documentation/TestingReadme.md)
